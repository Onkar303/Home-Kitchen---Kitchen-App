...
class Constants{
    ...
    static let ACCOUNT_KITCHEN_CUISINE_PARAM = "Cuisine"
    static let ACCOUNT_INFO_PARAMS = [ACCOUNT_PASSWORD_PARAM,ACCOUNT_KITCHEN_NAME_PARAM,ACCOUNT_KITCHEN_OWNER_PARAM,ACCOUNT_KITCHEN_ADDRESS_PARAM,ACCOUNT_KITCHEN_CONTACT_NUMBER_PARAM,ACCOUNT_KITCHEN_CUISINE_PARAM]
...
extension Constants{
    ...
    static let USERDEFAULTS_KITCHENCUISINE = "kitchenCuisine"
}
